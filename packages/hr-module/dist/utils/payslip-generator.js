...
exports.generatePayslipFile = generatePayslipFile;
/**
 ...
 */
function generatePayslipHTML(payslip, employee, config) {
 ...
 */
function formatAllowanceName(key) {
    return key
        .split('_')
 ...
 */
function generatePayslipFile(payslip, employee, config) {
