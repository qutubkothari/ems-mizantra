...
exports.calculateEndOfServiceBenefits = calculateEndOfServiceBenefits;
exports.calculateLeaveEncashment = calculateLeaveEncashment;
exports.generateWPSSIF = generateWPSSIF;
exports.validateEmiratesId = validateEmiratesId;
exports.calculateAnnualLeaveEntitlement = calculateAnnualLeaveEntitlement;
exports.calculateSickLeaveBalance = calculateSickLeaveBalance;
exports.getMaternityLeaveEntitlement = getMaternityLeaveEntitlement;
exports.calculateNoticePeriod = calculateNoticePeriod;
exports.generateMOLReport = generateMOLReport;
/**
 ...
 */
function calculateEndOfServiceBenefits(dateOfJoining, dateOfLeaving, lastBasicSalary) {
 ...
 */
function calculateLeaveEncashment(dateOfJoining, dateOfLeaving, unusedLeaveDays, dailyWage) {
    const joinDate = new Date(dateOfJoining);
    const leaveDate = new Date(dateOfLeaving);
    const diffTime = Math.abs(leaveDate.getTime() - joinDate.getTime());
    const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
 ...
 */
function generateWPSSIF(payslips, establishmentId, routingCode, month) {
 ...
 */
function calculateAnnualLeaveEntitlement(dateOfJoining, asOfDate = new Date().toISOString().split('T')[0]) {
    const joinDate = new Date(dateOfJoining);
 ...
 */
function calculateSickLeaveBalance(dateOfJoining, daysTaken) {
    const joinDate = new Date(dateOfJoining);
 ...
 */
function getMaternityLeaveEntitlement() {
    return {
        fullPay: 45,
        halfPay: 15,
        unpaidExtension: 45,
 ...
 */
function calculateNoticePeriod(contractType, yearsOfService) {
 ...
 */
function generateMOLReport(month, payslips, establishmentId) {
    const employees = payslips.map(payslip => ({
        employee_id: payslip.employee_id,
