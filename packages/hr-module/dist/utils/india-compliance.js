...
exports.calculatePF = calculatePF;
exports.calculateESI = calculateESI;
exports.calculateProfessionalTax = calculateProfessionalTax;
exports.calculateTDS = calculateTDS;
exports.calculateGratuity = calculateGratuity;
exports.generateForm16 = generateForm16;
exports.generatePFChallan = generatePFChallan;
exports.calculateLeaveEncashmentTax = calculateLeaveEncashmentTax;
 ...
 */
function calculatePF(basicSalary, da = 0, options = {}) {
 ...
 */
function calculateESI(grossWages) {
 ...
 */
function calculateProfessionalTax(grossSalary, state) {
    ...
    switch (stateCode) {
        ...
        case 'TN': // Tamil Nadu
            if (grossSalary <= 3500)
                return 0;
            if (grossSalary <= 5000)
                return 16.67; // Rs. 200 annually
            if (grossSalary <= 7500)
                return 37.50; // Rs. 450 annually
            if (grossSalary <= 10000)
                return 62.50; // Rs. 750 annually
 ...
 */
function calculateTDS(annualIncome, regime = 'new', deductions = {}) {
 ...
 */
function calculateGratuity(basicSalary, da, yearsOfService) {
    if (yearsOfService < 5) {
        return {
            isEligible: false,
            gratuityAmount: 0,
 ...
 */
function generateForm16(employeeId, financialYear, pan, quarterlyData) {
 ...
 */
function generatePFChallan(month, establishmentId, employees) {
 ...
 */
function calculateLeaveEncashmentTax(leaveEncashmentAmount) {
 ...
 */
function calculateBonus(basicPlusDa, workingDays = 365) {
