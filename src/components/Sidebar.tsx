...
const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Customers", href: "/dashboard/ems?view=accounts" },
...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  useEffect(() => {
    const activeSection = emsNavigation.find((item) =>
  ...
  }, [pathname, emsNavigation, manuallyCollapsedSections]);
