...
export const metadata: Metadata = {
  title: `EMS | Enquiry Management System | ${appBranding.companyName}`,
  description: `Enquiry Management System by ${appBranding.companyName}, powered by the Mizantra platform`,
  manifest: '/manifest.webmanifest',
  applicationName: 'EMS | Enquiry Management System',
  appleWebApp: {
    capable: true,
